<?php
    ...
    if (
        ...
        isset($_POST["instructions"]) && // fixed missing comma
        ...
        if (
            ...
            !empty($_POST["instructions"]) && // fixed missing comma
            ...
            $deplacement = new deplacement(
                ...
                $_POST['duree_depart'],
                $_POST['destination'],
                $_POST['instructions'], // fixed missing comma
                $_POST['cout_personne']
            );
            $deplacementC->modifier_deplacement($deplacement, $_POST["id_dep"]);
...
<body>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="row g-5">
                ...
                <button><a href="afficherdeplacement.php" class="envoyer-btn">Retour à la liste des deplacements</a></button>
    <hr>
    ...
    <?php
        if (isset($_POST['id_dep'])){
            $id_dep = $_POST['id_dep'];
            $deplacement = $deplacementC->recupererdeplacement($id_dep);
    ...
    <form action="" method="POST">
        <table border="1" align="center">
            <tr>
                <td>
                    <label for="id_dep">identifiant deplacement:
                    </label>
                </td>
                <td><input type="text" name="id_dep" id="id_dep" value="<?php echo $deplacement['id_dep']; ?>" maxlength="20"></td>
            </tr>
            <tr>
                <td>
                    <label for="data_depart">date de deplacement:
                    </label>
                </td>
                <td><input type="text" name="data_depart" id="data_depart" value="<?php echo $deplacement['data_depart']; ?>" maxlength="20"></td>
            </tr>
            <tr>
                <td>
                    <label for="lieu_depart">lieu de depart:
                    </label>
                </td>
                <td><input type="text" name="lieu_depart" id="lieu_depart" value="<?php echo $deplacement['lieu_depart']; ?>" maxlength="20"></td>
            </tr>
            <tr>
                <td>
                    <label for="duree_depart">duree de depart:
                    </label>
                </td>
                <td>
                        <input type="text" name="duree_depart" value="<?php echo $deplacement['duree_depart']; ?>" id="duree_depart">
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <input type="destination" name="destination" id="destination" value="<?php echo $deplacement['destination']; ?>">
                    </td>
                </tr>
                <tr>
                    <td>
                        <label for="instructions">instruction:
                        </label>
                    </td>
                    <td>
                        <input type="instructions" name="instructions" id="instructions" value="<?php echo $deplacement['instructions']; ?>">
                    </td>
                </tr>              
                <tr>
                    <td>
                    ...
                    <td>
                        <input type="cout_personne" name="cout_personne" id="cout_personne" value="<?php echo $deplacement['cout_personne']; ?>">
                    </td>
                </tr>              
                <tr>
                    <td></td>
                    <td>
                        <input type="submit" value="Modifier" class="envoyer-btn"> 
                    </td>
