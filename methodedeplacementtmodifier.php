  ...
  <body>
    ...
    <div class="layout-wrapper layout-content-navbar">
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="index.html" class="app-brand-link">
              ...
              <span class="app-brand-text demo menu-text fw-bolder ms-2">CUN</span>
            </a>
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item active">
              <a href="shopManagement.php" class="menu-link">
                <i class="menu-icon tf-icons bx bx-home-circle"></i>
                <div data-i18n="Analytics">Shop Manegement</div>
              </a>
            </li>
        ...
        <div class="layout-page">
          ...
          <div class="buy-now">
      <a
        href="methodedeplacementt.php"
        target="_blank"
        class="btn btn-danger btn-buy-now"
        >Retour  vers methodes deplacements</a
      >
    </div>
    ...
    <form action="" method="POST">
        <table border="1" align="center">
            ...
            <tr>
                <td>
                    <label for="points_bonus">points bonus :
                    </label>
                </td>
                <td>
                ...
                <td>
                    <label for="nb_passagers_max">nombre de passagers :
                    </label>
                </td>
