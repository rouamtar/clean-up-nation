...
>
  <head>
    ...
    <title>Clean Up Nation - Platform</title>
    ...
    <div class="layout-wrapper layout-content-navbar">
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="index.html" class="app-brand-link">
              ...
              <span class="app-brand-text demo menu-text fw-bolder ms-2">Clean up nation</span>
            </a>
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item active">
              <a href="methodedeplacementt.php" class="menu-link">
                <i class="menu-icon tf-icons bx bx-home-circle"></i>
                <div data-i18n="Analytics">méthode déplacement</div>
              </a>
            </li>
        ...
        <div class="layout-page">
          ...
          <div class="buy-now">
      <a
        href="methodedeplacementtajouter.php"
        target="_blank"
      ...
      >
		...
		<center><h1>méthode des déplacements</h1></center>
		<table border="1" align="center">
			...
			<tr>
				...
				<td>
					<form method="POST" action="methodedeplacementtmodifier.php">
				...
				<td>
					<a href="methodedeplacementtsupprimer.php?id_md=<?php echo $methodedeplacement['id_md']; ?>" class="red-btn">Supprimer</a>
				</td>
			</tr>
			<?php
				}
